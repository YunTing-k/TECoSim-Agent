...
Description: Type definitions for the WeChat SDK
...
Details:
---------
All type definitions for the WeChat Bot SDK as Python dataclasses. Includes: enums (MessageType, MessageState, MessageItemType,
MediaType, ContentType); incoming message structures (IncomingMessage with nested ImageContent, VoiceContent, FileContent,
VideoContent); CDN reference (CDNMedia with encrypt_query_param and aes_key); download/upload results (DownloadedMedia,
UploadResult); credentials (Credentials); and quoted message representation (QuotedMessage).
"""
