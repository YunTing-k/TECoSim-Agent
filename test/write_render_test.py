...
Covers: get_syntax_render with syntax highlighting, line-number gutter,
...
from src.tool.file_io_support import get_syntax_render


class TestWriteRender(unittest.TestCase):
    """Tests for get_syntax_render -- file content preview with syntax highlighting."""

    def test_basic_render(self):
        from unittest.mock import patch
        import os as _os
        with patch('os.get_terminal_size', return_value=_os.terminal_size((120, 40))):
            body = get_syntax_render("test.py", "x = 1\ny = 2\n")
        output = str(body)
    ...
    def test_syntax_highlighting_applied(self):
        ...
        import os as _os
        with patch('os.get_terminal_size', return_value=_os.terminal_size((120, 40))):
            body = get_syntax_render("test.py", "def foo():\n    return 42\n")
    ...
    def test_line_number_gutter(self):
        ...
        import io, re
        with patch('os.get_terminal_size', return_value=_os.terminal_size((120, 40))):
            body = get_syntax_render("test.py", "a = 1\nb = 2\nc = 3\n")
        f = io.StringIO()
    ...
    def test_long_line_wrap(self):
        ...
        with patch('os.get_terminal_size', return_value=_os.terminal_size((60, 40))):
            body = get_syntax_render("test.py", line)
        output = str(body)
    ...
    def test_truncation_by_lines(self):
        ...
        with patch('src.tool.file_io_support.WRITE_VIEW_MAX_LINES', 5):
            with patch('os.get_terminal_size', return_value=_os.terminal_size((120, 40))):
                body = get_syntax_render("test.txt", lines)
        output = str(body)
    ...
    def test_truncation_by_chars(self):
        ...
        with patch('src.tool.file_io_support.WRITE_VIEW_MAX_CHARS', 100):
            with patch('os.get_terminal_size', return_value=_os.terminal_size((120, 40))):
                body = get_syntax_render("test.txt", content)
        output = str(body)
    ...
    def test_empty_content(self):
        ...
        import os as _os
        with patch('os.get_terminal_size', return_value=_os.terminal_size((120, 40))):
            body = get_syntax_render("empty.py", "")
        output = str(body)
    ...
    def test_no_path_works(self):
        ...
        import os as _os
        with patch('os.get_terminal_size', return_value=_os.terminal_size((120, 40))):
            body = get_syntax_render("", "hello world\n")
    ...
    def test_cjk_content(self):
        ...
        import os as _os
        with patch('os.get_terminal_size', return_value=_os.terminal_size((120, 40))):
            body = get_syntax_render("test.py", 'x = "\u4e2d\u6587\u5b57\u7b26\u4e32"\n')
        output = str(body)
