...
results, flag, info = grep_impl({"pattern": "import re", "path": "..", "output_mode": "content"}, path="rg", timeout=20)
...
results, flag, info = grep_impl({"pattern": "import re", "path": "..", "output_mode": "files_with_matches"}, path="rg", timeout=20)
print(f"results: {results}\n"
      f"flag: {flag}\n"
      f"info: {info}\n")
...
results, flag, info = grep_impl({"pattern": "import re", "path": "..", "output_mode": "count"}, path="rg", timeout=20)
print(f"results: {results}\n"
      f"flag: {flag}\n"
      f"info: {info}\n")
...
results, flag, info = grep_impl({"pattern": "import re", "path": "..", "glob": "*.py", "output_mode": "files_with_matches"}, path="rg", timeout=20)
print(f"results: {results}\n"
      f"flag: {flag}\n"
      f"info: {info}\n")
...
results, flag, info = grep_impl({"pattern": "import re", "path": "..", "type": "py", "output_mode": "files_with_matches"}, path="rg", timeout=20)
print(f"results: {results}\n"
      f"flag: {flag}\n"
      f"info: {info}\n")
...
results, flag, info = grep_impl({"pattern": "IMPORT RE", "path": "..", "output_mode": "content", "ignore_case": True}, path="rg", timeout=20)
print(f"results: {results}\n"
      f"flag: {flag}\n"
      f"info: {info}\n")
...
results, flag, info = grep_impl({"pattern": "def main", "path": "../src/main.py", "output_mode": "content", "context": 2}, path="rg", timeout=20)
print(f"results: {results}\n"
      f"flag: {flag}\n"
      f"info: {info}\n")
...
results, flag, info = grep_impl({"pattern": "import", "path": "../src/main.py", "output_mode": "content", "head_limit": 2}, path="rg", timeout=20)
print(f"results: {results}\n"
      f"flag: {flag}\n"
      f"info: {info}\n")
...
results, flag, info = grep_impl({"pattern": "import", "path": "../src/main.py", "output_mode": "content", "head_limit": 0}, path="rg", timeout=20)
print(f"results: {results}\n"
      f"flag: {flag}\n"
      f"info: {info}\n")
...
results, flag, info = grep_impl({"pattern": r"re\.compile\(r'.*'\)", "path": "..", "output_mode": "content"}, path="rg", timeout=20)
print(f"results: {results}\n"
      f"flag: {flag}\n"
      f"info: {info}\n")
...
results, flag, info = grep_impl({"pattern": r"def main\(\):[\s\S]*?main\(\)", "path": "..", "output_mode": "content", "multiline": True}, path="rg", timeout=20)
print(f"results: {results}\n"
      f"flag: {flag}\n"
      f"info: {info}\n")
...
results, flag, info = grep_impl({"pattern": "nonexistent_xyz123", "path": "./any_path_no_exist", "output_mode": "content"}, path="rg", timeout=20)
print(f"results: {results}\n"
      f"flag: {flag}\n"
      f"info: {info}\n")
...
print("\n=== 13. JSON file search ===")
results, flag, info = grep_impl({"pattern": "version", "path": ".", "glob": "*.json", "output_mode": "content"}, path="rg", timeout=20)
print(f"results: {results}\n"
      f"flag: {flag}\n"
      f"info: {info}\n")
...
results, flag, info = grep_impl({"pattern": "def", "path": "../main.py", "output_mode": "content"}, path="rg", timeout=20)
print(f"results: {results}\n"
      f"flag: {flag}\n"
      f"info: {info}\n")
...
print("\n=== 15. count + head_limit ===")
results, flag, info = grep_impl({"pattern": "import", "path": "..", "output_mode": "count", "head_limit": 2}, path="rg", timeout=20)
print(f"results: {results}\n"
      f"flag: {flag}\n"
      f"info: {info}\n")
...
print("\n=== 16. search subdirectory ===")
results, flag, info = grep_impl({"pattern": "re", "path": "subdir", "output_mode": "files_with_matches"}, path="rg", timeout=20)
print(f"results: {results}\n"
      f"flag: {flag}\n"
      f"info: {info}\n")
