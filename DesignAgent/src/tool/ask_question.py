...
def render_questions(questions: list[dict[str, Any]], active_idx: int, selected_indices: list[int],
    ...
    """render the questions according to the selections in single row"""
    panels = []
...
def ask_user_question_tui(questions: list[dict[str, Any]], console, agent_session: PromptSession) -> list[dict[str, Any]]:
